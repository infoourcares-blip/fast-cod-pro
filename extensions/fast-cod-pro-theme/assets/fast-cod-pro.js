(function () {
  ...
  function buildModalHtml(productTitle, productImage, displayPrice, variantId, price, submitUrl, shopDomain) {
    return (
      ...
      "</div>" +
      '<form class="fast-cod-pro-grid" data-fast-cod-form method="post" action="/cart/add">' +
  ...
  async function enhanceFields(container, endpoint, accentColor) {
    try {
      ...
      container.dataset.formButtonLabel = formConfig.formButtonLabel || formConfig.submitButtonLabel || "Place Fast COD Pro Order";
      if (launcherIcon) {
